...
.section-title {
    ...
    font-weight: 800;
    /* Ajuste Flexbox para alinear la barra decorativa con el texto */
    display: flex;
    align-items: center;
    gap: 12px;
}
...
.section-title::before {
    ...
    height: 38px;
    border-radius: 999px;
    background: linear-gradient(var(--server-color), var(--color-accent));
    box-shadow: 0 0 12px var(--server-color);
}
